...
public class ModItems {
    ...
    public static final Item WOOD_PAXEL = registerItem("wood_paxel",
            new PaxelItem(ModToolMaterials.PAXEL_WOOD,
                    new Item.Settings().attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.STONE, 4, -3.1f))));
    ...
    public static final Item IRON_PAXEL = registerItem("iron_paxel",
            new PaxelItem(ModToolMaterials.PAXEL_IRON,
                    new Item.Settings().attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.IRON, 4, -3.1f))));
    public static final Item GOLDEN_PAXEL = registerItem("golden_paxel",
            new PaxelItem(ModToolMaterials.PAXEL_GOLD,
                    new Item.Settings().attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.GOLD, 4, -3.1f))));
    public static final Item DIAMOND_PAXEL = registerItem("diamond_paxel",
            new PaxelItem(ModToolMaterials.PAXEL_DIAMOND,
                    new Item.Settings().attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.DIAMOND, 4, -3.1f))));
    public static final Item NETHERITE_PAXEL = registerItem("netherite_paxel",
            new PaxelItem(ModToolMaterials.PAXEL_NETHERITE,
                    new Item.Settings().attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.NETHERITE, 6, -3.1f))));
